            ...
            <main className="flex-1 pt-24">
                ...
                <section className="bg-primary/5 py-24">
                    <div className="container mx-auto px-6 text-center space-y-8">
                        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-primary-foreground/90 text-foreground text-green-800">Ready to optimize your production?</h2>
